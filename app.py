...
# Versão final com imports corrigidos e configuração segura

import os  # ✅ ADICIONADO - Import obrigatório
import datetime
import re
import io
import json
...
# ✅ SEGURO - Apenas variáveis de ambiente, sem chaves hardcoded
...
"""
        ...
        article_data.update({
            ...
            'specificObjective': '',
            'selectionDate': today,
            'summary': ai_summary# --- APLICAÇÃO PARA RENDER COM MÚLTIPLAS FONTES ACADÊMICAS ---
# Versão final com imports corrigidos e configuração segura
